...
use App\Http\GraphQL\Queries\Weather\WeatherInfosQuery;
...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                //Weather
                'weather' => WeatherInfosQuery::class
            ],
            'mutation' => [
                // Users
    ...
    'types' => [
        ...
        'hgWeather'=> HgWeatherType::class,
        'hgWeatherResults'=> HgWeatherResultsType::class,
        'hgWeatherForecast'=> HgWeatherForecastType::class,
    ],
